![waving](https://capsule-render.vercel.app/api?type=waving&height=200&text=Muing's%20Github&fontAlign=32&fontAlignY=40&color=gradient)

### :see_no_evil: | Introduce

안녕하세요!<br/>
요즘은 개발 직군에서 3D 아티스트로 전향을 심히 고려하고 있어요.<br/>
개발 능력은 어느정도 수준으로만 유지하고 3D 공부에 집중하고 있답니다.<br/>
그와중에도 rust 언어는 흥미롭군요.<br/>
...
>- Rust 끝까지 공부하기
>- 개발 능력 유지하기
>- 어느 길을 가든 그 길과 하나가 되기 (시작하고, 끝까지 하기)
